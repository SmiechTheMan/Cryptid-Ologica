...
public enum ModArmorMaterials implements ArmorMaterial {
    BIGFOOT_FUR("bigfoot_fur",3,new int[]{0,4,0,0},25,
            SoundEvents.AZALEA_LEAVES_FALL,1f,0f, ()->Ingredient.of(ModItems.BIGFOOT_FUR_ITEM.get()));
    ...
    public String getName() {
        return CryptidOlogica.MOD_ID + ":" + this.name;
    }
