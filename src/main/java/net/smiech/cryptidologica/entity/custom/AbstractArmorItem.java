...
import net.smiech.cryptidologica.entity.client.armor.model.ArmorModel;
...
public abstract class AbstractArmorItem extends ArmorItem {
    ...
    public static String makeCustomTextureLocation(String nameSpace, String id) {
        return ResourceLocation.fromNamespaceAndPath(nameSpace, "textures/armor/" + id + ".png").toString();
